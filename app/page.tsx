...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-center bg-black text-white px-6 py-12 font-serif">
      {/* Hero Section */}
      <section className="w-full bg-cover bg-center h-screen flex items-center justify-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1612832021035-3e0e6c8f3e4e')" }}>
        <div className="bg-black bg-opacity-50 p-10 rounded">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8">The digital sanctuary for elite entrepreneurs, visionaries & AI-empowered thinkers.</p>
          <a href="mailto:access@theonepercent.ai" className="mt-6 px-6 py-3 bg-white text-black font-semibold rounded-full hover:bg-gray-200 transition">Request Access</a>
        </div>
      </section>
